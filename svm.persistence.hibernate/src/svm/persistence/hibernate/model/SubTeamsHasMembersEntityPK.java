...
public class SubTeamsHasMembersEntityPK implements Serializable {
    ...
    @ManyToOne(cascade = CascadeType.ALL, targetEntity = SubTeamEntity.class, fetch = FetchType.LAZY)
    ...
    @ManyToOne(cascade = CascadeType.ALL, targetEntity = MemberEntity.class, fetch = FetchType.LAZY)
